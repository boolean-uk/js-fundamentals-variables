...
const CHOICES = [
  ...
  [1, 2, 3], // 7 
  { i: 'object!' }, // 8
  2 > 1, // HINT: Is this true or false? -> true // 9
  3 === 4 // HINT: Is this true or false? -> false // 10
]
...
const aReal = pick(4) // we interpret "real" as positive

// 3. Pick a string
const aString = pick(6) // would the n in pos. 5 interfere with the variable of the pick function being also called n?

// 4. Pick an array
const anArray = pick(7)

// 5. Pick a (simple) number 
const aNumber = pick(3) // we interpret "simple" as no decimals
