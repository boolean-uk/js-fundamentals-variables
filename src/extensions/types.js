...
const imTrue = pick(9) // 2 > 1

// 2. Pick a real number
const aReal = pick(4) // 3.14

// 3. Pick a string
const aString = pick(6) // 'Pick me'

// 4. Pick an array
const anArray = pick(7) // [1, 2, 3]

// 5. Pick a (simple) number
const aNumber = pick(3) // -12

// 6. Pick an object
const anObject = pick(8) // { i: 'object!' }
